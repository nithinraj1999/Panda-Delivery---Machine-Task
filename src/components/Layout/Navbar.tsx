...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" hidden xl:flex justify-between z-50 py-[40px] px-[80px] bg-white fixed shadow-[0_0_36px_0_rgba(0,0,0,0.06)] w-full h-[100px] max-width-[1440px] z-50">
        <div className="flex items-center">
          <Logo />
        </div>
        <ul className="flex items-center space-x-[40px]  font-atypdisplay  h-[26px] gap-[8px] leading-[160%]">
          <li><a href="#" className="text-[#F89938]   font-semibold">Home</a></li>
          <li><a href="#" className="font-normal">Why Panda</a></li>
          ...
          <li><a href="#" className="font-normal">Track Shipment</a></li>
          <li><a href="#" className="font-normal">Gallery</a></li>
          <li><a href="#" className="font-normal">Blog</a></li>
          <li><a href="#" className="font-normal">Contact Us</a></li>
        </ul>

        <div className=" h-[44px]">
          <a
            href="#"
            className="bg-[#F89938]  w-[132px] gap-[12px] text-white font-atypdisplay font-semibold py-2 px-6 rounded-[9999px]"
          >
            Client Portal
          </a>
        </div>
