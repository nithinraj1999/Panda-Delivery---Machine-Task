...
const TestimonialCard = ({ testimonial }: { testimonial: any }) => {
  return (
    ...
    >
      ...
      <p className="text-[#9C9C9C] font-plusjakartasans font-normal text-[18px] mb-4">{testimonial.text}</p>

      <hr className="border-t border-gray-200 my-4 w-full" />

      <div className="flex justify-between items-center w-full">
        <div className="text-left">
          <h3 className="font-inter font-medium  text-gray-900 ">{testimonial.name}</h3>
          <p className="font-plusjakartasans font-normal text-[#9C9C9C] text-base">{testimonial.role}</p>
        </div>
