const TrackingInfoBar = () => {
  return (
    <div
      className="flex flex-col lg:flex-row bg-[#003164] px-[80px] py-[32px] text-white h-[196px] items-center justify-center gap-x-6"
    >
      <div className="flex-1 flex items-center justify-center lg:justify-start px-6 lg:px-12 py-6 lg:py-0">
        <h2 className="text-2xl font-bold">
          Easy <br /> Tracking
        </h2>
      </div>

      <div className="flex-1 flex items-start gap-4  pl-6 lg:pl-12 py-6 lg:py-0  ">
      ...
      <div className="flex-1 flex items-start gap-3 px-6 lg:px-12 py-6 lg:py-0 border-l border-white/30">
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
