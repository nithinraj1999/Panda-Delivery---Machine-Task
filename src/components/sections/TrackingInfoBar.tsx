const TrackingInfoBar = () => {
  return (
    <div
      className="flex flex-col lg:flex-row bg-[#003164] px-[20px] sm:px-[40px] md:px-[60px] lg:px-[80px] py-[32px] text-white h-auto lg:h-[196px] items-center justify-center gap-y-6 lg:gap-x-6"
    >
      ...
      <div className="flex-1 flex flex-col sm:flex-row items-center sm:items-start gap-4 pl-6 lg:pl-12 py-6 lg:py-0 border-t lg:border-t-0 lg:border-l border-white/30">
