const TrackingInfoBar = () => {
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center lg:items-start px-6 lg:px-12 py-6 lg:py-0 text-center lg:text-left">
        <h2 className="text-2xl font-medium">
          Easy <br /> Tracking
        </h2>
      </div>

      <div className="flex-1 flex flex-col items-center sm:flex-row sm:items-start gap-4 px-6 lg:px-12 py-6 lg:py-0 text-center lg:text-left">
        ...
        <div>
          ...
          <p className="text-[15px] font-normal">Let's take this conversation teams were able.</p>
        </div>
      </div>

      <div className="flex-1 flex flex-col items-center sm:flex-row sm:items-start gap-3 px-6 lg:px-12 py-6 lg:py-0 border-t lg:border-t-0 lg:border-l border-white/30 text-center lg:text-left">
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
